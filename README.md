# PSOC™ Edge E3 Training - Encryption

This training is part of the PSOC™ Edge Security training series and introduces encryption support for PSOC™ Edge. It covers single-key XIP encryption, multi-key XIP encryption, and secure encryption, culminating in a hands-on lab to enable encryption using the Edge Protect Bootloader.
...
## Duration
- 1 hour, including video and hands-on labs

## Agenda
1. Introduction
2. Single-key XIP encryption
3. Multi-key XIP encryption
4. Secure encryption
5. Lab #1: Single-key XIP encryption with Edge Protect Bootloader (EPB)
6. Lab #2: Multi-key XIP encryption

## Expected outcome
- Become familiar with application encryption on PSOC™ Edge
